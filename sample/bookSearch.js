...
async function getUpcomingBooks(genre) {
    const API_KEY = "AIzaSyC2y-OtczB9wStf2qF5peZK0IPzCtlRJHM";
    const url = `https://www.googleapis.com/books/v1/volumes?q=new+releases+${genre}&orderBy=relevance&maxResults=20&key=${API_KEY}`;         console.log(url);
